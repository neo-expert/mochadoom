...
public enum GameMode {
  ...
  pack_xbla("cdata", XBLA_WAD,
      CommandVariable.COMDEV), // XBLA Doom. How you got hold of it, I don't care :-p
  ...
  public boolean hasTexture2() {
    return !(this == GameMode.shareware || this == GameMode.freedoom2 ||
        this == GameMode.commercial);
  }
}
