...
public interface IWadLoader {
  ...
  void InitMultipleFiles(String[] filenames) throws IOException;
  ...
  @W_Wad.C(W_CacheLumpName)
  <T extends CacheableDoomObject> T CacheLumpName(String name, int tag,
                                                  Class<T> what);
  ...
  <T extends CacheableDoomObject> T[] CacheLumpNumIntoArray(int lump, int num,
