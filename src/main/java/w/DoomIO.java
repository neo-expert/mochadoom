...
public class DoomIO {
  ...
  public static final String readString(DataInputStream dis) throws IOException {
    ...
    return new String(bb, 0, len, StandardCharsets.ISO_8859_1);
  }
  ...
  public static final String readNullTerminatedString(InputStream dis, int len) throws IOException {
    ...
    return new String(bb, 0, terminator, StandardCharsets.ISO_8859_1);
  }
  ...
  public static final String[] readMultipleFixedLengthStrings(DataInputStream dis, String[] dest,
                                                              int num, int len) throws IOException {
  ...
  public static final void readIntArray(DataInputStream dis, int[] s, int len, ByteOrder bo)
      throws IOException {
  ...
  public static final void readShortArray(DataInputStream dis, short[] s, int len, ByteOrder bo)
      throws IOException {
  ...
  public static final void readIntArray(DataInputStream dis, int[] s, ByteOrder bo)
      throws IOException {
    readIntArray(dis, s, s.length, bo);
  }

  public static final void readShortArray(DataInputStream dis, short[] s, ByteOrder bo)
      throws IOException {
    readShortArray(dis, s, s.length, bo);
  }

  public static void readBooleanArray(DataInputStream dis, boolean[] s, int len)
      throws IOException {
  ...
  public final static void readBooleanIntArray(DataInputStream dis, boolean[] s, int len)
      throws IOException {
  ...
  public static final void readBooleanIntArray(DataInputStream dis, boolean[] s)
      throws IOException {
    readBooleanIntArray(dis, s, s.length);
  }

  public static final void writeBoolean(DataOutputStream dos, boolean[] s, int len)
      throws IOException {
  ...
  public static final void writeObjectArray(DataOutputStream dos, IWritableDoomObject[] s, int len)
      throws IOException {
  ...
  public static final void writeListOfObjects(DataOutputStream dos, List<IWritableDoomObject> s,
  ...
  public final static void readIntBooleanArray(DataInputStream dis, boolean[] s)
      throws IOException {
    readBooleanIntArray(dis, s, s.length);
  }

  public static final void writeCharArray(DataOutputStream dos, char[] charr, int len)
      throws IOException {
  ...
  public static final void readCharArray(DataInputStream dis, char[] charr, int len)
      throws IOException {
  ...
  public static final void readNonUnicodeCharArray(DataInputStream dis, char[] charr, int len)
      throws IOException {
