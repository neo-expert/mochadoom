...
// Range goes from 0x00000000 to 0x20000000, so in theory plain ints should be enough...
   ...
   */
  public static int SlopeDiv(long num, long den) {
    int ans;
   ...
   * @return
   */
  public static int finesine(int angle) {
   ...
   * @return
   */
  public static int finesine(long angle) {
   ...
   * @return
   */
  public static int finecosine(int angle) {
   ...
   * @return
   */
  public static int finecosine(long angle) {
  ...
  public static int BAMDiv(int bam0, int bam1) {
    // bam0 is greater than 180 degrees.
    if (bam0 >= 0) {
      return bam0 / bam1;
    }
    ...
    if (bam1 >= 0) {
      return (int) ((0x0FFFFFFFFL & bam0) / bam1);
    }

    return (int) ((0x0FFFFFFFFL & bam0) / (0x0FFFFFFFFL & bam1));
  }
  ...
  public static int toBAMIndex(long angle) {
  ...
  public static int toFineTanIndex(long angle) {
  ...
  public static int toBAMIndex(int angle) {
