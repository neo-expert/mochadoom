...
public class Wipers implements ColorTransform, Melt {
  ...
  public static <V, E extends Enum<E>> Wiper createWiper(IRandom rnd, Screens<V, E> screens, E ws,
                                                         E we, E ms) {
  ...
  protected final static class WiperImpl<V, E extends Enum<E>> implements Wiper {
    ...
    private WiperImpl(IRandom RND, Screens<V, E> screens, E wipeStartScreen, E wipeEndScreen,
                      E mainScreen) {
      this.random = RND;
