...
import static v.renderers.DoomScreen.WE;
import static v.renderers.DoomScreen.WS;
import static v.renderers.DoomScreen.mapScreensToBuffers;
...
abstract class SoftwareGraphicsSystem<T, V>
    implements DoomGraphicSystem<T, V>, Rectangles<V, DoomScreen>, Blocks<V, DoomScreen>,
    Patches<V, DoomScreen>, Lines {
  /**
  ...
  private V[] colormap(RendererFactory.WithWadLoader<T, V> rf) {
    ...
    return
        ...
        bufferType == byte[].class
            ...
            : colormapEnabled
            // TrueColor, check for cfg setting and command line argument -nocolormap
  ...
  @Override
  public void DrawPatchCenteredScaled(DoomScreen screen, patch_t patch, VideoScale vs, int y,
                                      int... flags) {
    Patches.super.DrawPatchCenteredScaled(screen, patch, vs, y, flags);
  }

  @Override
  public void DrawPatchScaled(DoomScreen screen, patch_t patch, VideoScale vs, int x, int y,
                              int... flags) {
  ...
  @Override
  public void FillRect(DoomScreen screenType, Rectangle rectangle, V patternSrc,
                       Horizontal pattern) {
  ...
  @Override
  public void TileScreenArea(DoomScreen dstScreen, Rectangle screenArea, V block,
                             Rectangle blockArea) {
