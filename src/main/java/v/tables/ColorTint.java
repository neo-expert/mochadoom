...
public class ColorTint {
  public final byte[][] LUT_r8 = new byte[5][0x100];  public final static ColorTint
  ...
  GREY_NORMAL = new ColorTint(NORMAL.mid(), NORMAL.mid5(), NORMAL.purepart),
      ...
      GREY_BERSERK_SLIGHT =
          new ColorTint(BERSERK_SLIGHT.mid(), BERSERK_SLIGHT.mid5(), BERSERK_SLIGHT.purepart),
      GREY_BERSERK_SOMEWHAT =
          new ColorTint(BERSERK_SOMEWHAT.mid(), BERSERK_SOMEWHAT.mid5(), BERSERK_SOMEWHAT.purepart),
      GREY_BERSERK_NOTICABLE = new ColorTint(BERSERK_NOTICABLE.mid(), BERSERK_NOTICABLE.mid5(),
          BERSERK_NOTICABLE.purepart),
      GREY_BERSERK_HEAVY =
          new ColorTint(BERSERK_HEAVY.mid(), BERSERK_HEAVY.mid5(), BERSERK_HEAVY.purepart),
  ...
  public static final List<ColorTint> GREY_TINTS = Collections.unmodifiableList(Arrays.asList(
      GREY_NORMAL,
      GREY_RED_11, GREY_RED_22, GREY_RED_33, GREY_RED_44, GREY_RED_55, GREY_RED_66, GREY_RED_77,
      GREY_RED_88,
      GREY_BERSERK_SLIGHT, GREY_BERSERK_SOMEWHAT, GREY_BERSERK_NOTICABLE, GREY_BERSERK_HEAVY,
      GREY_RADSUIT
  ));
  public final byte[][] LUT_g8 = new byte[5][0x100];
  /*public static List<ColorTint> generateTints(byte cmaps[][]) {
  }*/
  public final byte[][] LUT_b8 = new byte[5][0x100];  public static final List<ColorTint> NORMAL_TINTS = Collections.unmodifiableList(Arrays.asList(
      NORMAL,
