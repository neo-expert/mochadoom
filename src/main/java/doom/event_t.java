...
public interface event_t {
  ...
  default <T> boolean withKey(Consumer<? super T> scConsumer,
                              Function<? super ScanCode, ? extends T> extractor) {
    return false;
  }

  default <T> boolean ifKey(Predicate<? super T> scCondition,
                            Function<? super ScanCode, ? extends T> extractor) {
    return false;
  }
  ...
  default <T> boolean withMouse(Consumer<? super T> mouseConsumer,
                                Function<? super mouseevent_t, ? extends T> extractor) {
    return false;
  }

  default <T> boolean ifMouse(Predicate<? super T> mouseCondition,
                              Function<? super mouseevent_t, ? extends T> extractor) {
    return false;
  }
  ...
  default <T> boolean withJoy(Consumer<? super T> joyConsumer,
                              Function<? super joyevent_t, ? extends T> extractor) {
    return false;
  }

  default <T> boolean ifJoy(Predicate<? super T> joyCondition,
                            Function<? super joyevent_t, ? extends T> extractor) {
    return false;
  }
  ...
  final class keyevent_t implements event_t {
    ...
    @Override
    public <T> boolean ifKey(Predicate<? super T> scCondition,
                             Function<? super ScanCode, ? extends T> extractor) {
      return scCondition.test(extractor.apply(sc));
    }

    @Override
    public <T> boolean withKey(Consumer<? super T> scConsumer,
                               Function<? super ScanCode, ? extends T> extractor) {
  ...
  final class mouseevent_t implements event_t {
    ...
    public void moveIn(MouseEvent ev, Robot robot, Point windowOffset, int centreX, int centreY,
                       boolean drag) {
    ...
    @Override
    public <T> boolean ifMouse(Predicate<? super T> mouseCondition,
                               Function<? super mouseevent_t, ? extends T> extractor) {
      return mouseCondition.test(extractor.apply(this));
    }

    @Override
    public <T> boolean withMouse(Consumer<? super T> mouseConsumer,
                                 Function<? super mouseevent_t, ? extends T> extractor) {
  ...
  final class joyevent_t implements event_t {
    ...
    @Override
    public <T> boolean ifJoy(Predicate<? super T> joyCondition,
                             Function<? super joyevent_t, ? extends T> extractor) {
      return joyCondition.test(extractor.apply(this));
    }

    @Override
    public <T> boolean withJoy(Consumer<? super T> joyConsumer,
                               Function<? super joyevent_t, ? extends T> extractor) {
