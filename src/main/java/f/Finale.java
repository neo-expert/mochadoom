...
import static doom.englsh.C1TEXT;
import static doom.englsh.C2TEXT;
import static doom.englsh.C3TEXT;
import static doom.englsh.C4TEXT;
import static doom.englsh.C5TEXT;
import static doom.englsh.C6TEXT;
import static doom.englsh.CC_ARACH;
import static doom.englsh.CC_ARCH;
import static doom.englsh.CC_BARON;
import static doom.englsh.CC_CACO;
import static doom.englsh.CC_CYBER;
import static doom.englsh.CC_DEMON;
import static doom.englsh.CC_HEAVY;
import static doom.englsh.CC_HELL;
import static doom.englsh.CC_HERO;
import static doom.englsh.CC_IMP;
import static doom.englsh.CC_LOST;
import static doom.englsh.CC_MANCU;
import static doom.englsh.CC_PAIN;
import static doom.englsh.CC_REVEN;
import static doom.englsh.CC_SHOTGUN;
import static doom.englsh.CC_SPIDER;
import static doom.englsh.CC_ZOMBIE;
import static doom.englsh.E1TEXT;
import static doom.englsh.E2TEXT;
import static doom.englsh.E3TEXT;
import static doom.englsh.E4TEXT;
import static doom.englsh.P1TEXT;
import static doom.englsh.P2TEXT;
import static doom.englsh.P3TEXT;
import static doom.englsh.P4TEXT;
import static doom.englsh.P5TEXT;
import static doom.englsh.P6TEXT;
import static doom.englsh.T1TEXT;
import static doom.englsh.T2TEXT;
import static doom.englsh.T3TEXT;
import static doom.englsh.T4TEXT;
import static doom.englsh.T5TEXT;
import static doom.englsh.T6TEXT;
...
public class Finale<T> {
  ...
  public void CastDrawer() {
    ...
    DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("BOSSBACK", PU_CACHE),
        DOOM.vs, 0, 0);
    ...
    final patch_t patch =
        DOOM.wadLoader.CachePatchNum(lump + DOOM.spriteManager.getFirstSpriteLump());
  ...
  public void BunnyScroll() {
    ...
    if (finalecount < 1130) {
      ...
      DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("END0", PU_CACHE),
          DOOM.vs, (320 - 13 * 8) / 2, ((200 - 8 * 8) / 2));
      laststage = 0;
      return;
    }
    ...
    DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName(name, PU_CACHE), DOOM.vs,
        ...
        case 1:
			if (DOOM.isCommercial() || DOOM.isRegistered()) {
				DOOM.graphicSystem.DrawPatchScaled(FG,
						DOOM.wadLoader.CachePatchName("CREDIT", PU_CACHE), this.DOOM.vs, 0, 0);
			} else
			// Fun fact: Registered/Ultimate Doom has no "HELP2" lump.
			{
				DOOM.graphicSystem.DrawPatchScaled(FG,
						DOOM.wadLoader.CachePatchName("HELP2", PU_CACHE),
						this.DOOM.vs, 0, 0);
			}
          break;
        case 2:
          DOOM.graphicSystem.DrawPatchScaled(FG,
              DOOM.wadLoader.CachePatchName("VICTORY2", PU_CACHE), this.DOOM.vs, 0, 0);
          break;
        case 3:
          BunnyScroll();
          break;
        case 4:
          DOOM.graphicSystem.DrawPatchScaled(FG, DOOM.wadLoader.CachePatchName("ENDPIC", PU_CACHE),
              this.DOOM.vs, 0, 0);
          break;
      }
    }
