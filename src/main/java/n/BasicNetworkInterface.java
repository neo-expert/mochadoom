...
public class BasicNetworkInterface implements DoomSystemNetworking {
  ...
  public void InitNetwork() {
    ...
    doomcom.consoleplayer =
        (short) (DOOM.cVarManager.get(CommandVariable.NET, Character.class, 0).get() - '1');
    ...
    public void invoke() {
          ...
          System.out.println();*/
      {
        ...
        if (first) {
          ...
          sb.append(" 0x");
          sb.append(DoomBuffer.getBEInt(recvData.retransmitfrom, recvData.starttic, recvData.player,
              recvData.numtics));
