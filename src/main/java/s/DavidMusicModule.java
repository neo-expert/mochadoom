...
public class DavidMusicModule implements IMusic {
  ...
  public void InitMusic() {
    try {
      ...
      sendSysexMessage(receiver, (byte) 0xf0, (byte) 0x7e, (byte) 0x7f, (byte) 9, (byte) 1,
          (byte) 0xf7);
  ...
  private void sendRegParamChange(Receiver receiver, int midiChan, int paramMsb, int paramLsb,
                                  int valMsb) {
