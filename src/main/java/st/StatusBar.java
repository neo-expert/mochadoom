...
public class StatusBar extends AbstractStatusBar {
  ...
  // For Responder
  private static final int ST_TOGGLECHAT = Signals.ScanCode.SC_ENTER.c;
  ...
  private static final int ST_TURNCOUNT = (TICRATE);
  private static final int ST_OUCHCOUNT = (TICRATE);
  ...
  private final int ST_X = 0;
  private final int ST_X2;
  private final int ST_FX;
  private final int ST_FY;
  private final Rectangle ST_RECT;
  private final int ST_FACESX;
  private final int ST_FACESY;
  // AMMO number pos.
  private final int ST_AMMOWIDTH;
  private final int ST_AMMOX;
  private final int ST_AMMOY;
  // HEALTH number pos.
  private int ST_HEALTHWIDTH = 3;
  private final int ST_HEALTHX;
  private final int ST_HEALTHY;
  // Weapon pos.
  private final int ST_ARMSX;
  private final int ST_ARMSY;
  private final int ST_ARMSBGX;
  private final int ST_ARMSBGY;
  private final int ST_ARMSXSPACE;
  private final int ST_ARMSYSPACE;
  // Frags pos.
  private final int ST_FRAGSX;
  private final int ST_FRAGSY;
  private final int ST_FRAGSWIDTH;
  // ARMOR number pos.
  private final int ST_ARMORWIDTH = 3;
  private final int ST_ARMORX;
  private final int ST_ARMORY;
  // Key icon positions.
  private final int ST_KEY0WIDTH;
  private final int ST_KEY0HEIGHT;
  private final int ST_KEY0X;
  private final int ST_KEY0Y;
  private final int ST_KEY1WIDTH;
  private final int ST_KEY1X;
  private final int ST_KEY1Y;
  private final int ST_KEY2WIDTH;
  private final int ST_KEY2X;
  private final int ST_KEY2Y;
  // Ammunition counter.
  private final int ST_AMMO0WIDTH;
  private final int ST_AMMO0HEIGHT;
  private final int ST_AMMO0X;
  private final int ST_AMMO0Y;
  private final int ST_AMMO1WIDTH;
  private final int ST_AMMO1X;
  private final int ST_AMMO1Y;
  private final int ST_AMMO2WIDTH;
  private final int ST_AMMO2X;
  private final int ST_AMMO2Y;
  private final int ST_AMMO3WIDTH;
  private final int ST_AMMO3X;
  private final int ST_AMMO3Y;
  // Indicate maximum ammunition.
  // Only needed because backpack exists.
  private final int ST_MAXAMMO0WIDTH;
  private final int ST_MAXAMMO0HEIGHT;
  private final int ST_MAXAMMO0X;
  private final int ST_MAXAMMO0Y;
  private final int ST_MAXAMMO1WIDTH;
  private final int ST_MAXAMMO1X;
  private final int ST_MAXAMMO1Y;
  private final int ST_MAXAMMO2WIDTH;
  private final int ST_MAXAMMO2X;
  private final int ST_MAXAMMO2Y;
  private final int ST_MAXAMMO3WIDTH;
  private final int ST_MAXAMMO3X;
  private final int ST_MAXAMMO3Y;
  ...
  // ST_CHATFONTWIDTH);
  // pistol
  private final int ST_WEAPON0X;
  private final int ST_WEAPON0Y;
  // shotgun
  private final int ST_WEAPON1X;
  private final int ST_WEAPON1Y;
  // chain gun
  private final int ST_WEAPON2X;
  private final int ST_WEAPON2Y;
  // missile launcher
  private final int ST_WEAPON3X;
  private final int ST_WEAPON3Y;
  // plasma gun
  private final int ST_WEAPON4X;
  private final int ST_WEAPON4Y;
  // bfg
  private final int ST_WEAPON5X;
  private final int ST_WEAPON5Y;
  // WPNS title
  private final int ST_WPNSX;
  private final int ST_WPNSY;
  // DETH title
  private final int ST_DETHX;
  private final int ST_DETHY;
  // main player in game
   ...
   * close to a pointer.
   */
  private final boolean[] st_statusbaron = {false};
  // whether status bar chat is active
  private boolean st_chat;
  // value of st_chat before message popped up
  private boolean st_oldchat;
  // whether chat window has the cursor on
  private final boolean[] st_cursoron = {false};

  // // WIDGETS /////
  /**
   * !deathmatch
   */
  private final boolean[] st_notdeathmatch = {true};
  /**
   * !deathmatch && st_statusbaron
   */
  private final boolean[] st_armson = {true};
  /**
   * !deathmatch
   */
  private final boolean[] st_fragson = {false};
  // main bar left
  private patch_t sbar;
  // 0-9, tall numbers
  private final patch_t[] tallnum = new patch_t[10];
  // tall % sign
  private patch_t tallpercent;
  // 0-9, short, yellow (,different!) numbers
  private final patch_t[] shortnum = new patch_t[10];
  // 3 key-cards, 3 skulls
  private final patch_t[] keys = new patch_t[NUMCARDS];
  // face status patches
  private final patch_t[] faces = new patch_t[ST_NUMFACES];
  // face background
  ...
  private final patch_t[][] arms = new patch_t[6][2];
  // ready-weapon widget
  ...
  private final st_multicon_t[] w_arms = new st_multicon_t[6];
  // face status widget
  private st_multicon_t w_faces;
  // keycard widgets
  private final st_multicon_t[] w_keyboxes = new st_multicon_t[3];
  // armor widget
  private st_percent_t w_armor;
  // ammo widgets
  private final st_number_t[] w_ammo = new st_number_t[4];
  // max ammo widgets
  private final st_number_t[] w_maxammo = new st_number_t[4];
  // number of frags so far in deathmatch
  private final int[] st_fragscount = {0};
  // used to use appopriately pained face
  private int st_oldhealth = -1;
  // used for evil grin
  private final boolean[] oldweaponsowned = new boolean[NUMWEAPONS];
  // count until face changes
  private int st_facecount = 0;
  // current face index, used by w_faces
  private final int[] st_faceindex = new int[1];
  // holds key-type for each key box on bar
  private final int[] keyboxes = new int[3];
  ...
  // Yeah, right...
  private final char[] cheat_mus_seq =
      {0xb2, 0x26, 0xb6, 0xae, 0xea, 1, 0, 0, 0xff};
  // Now what?
  cheatseq_t cheat_mus = new cheatseq_t(cheat_mus_seq, 0);
  private final char[] cheat_choppers_seq =
      {0xb2, 0x26, 0xe2, 0x32, 0xf6, 0x2a, 0x2a, 0xa6, 0x6a, 0xea, 0xff // id...
      };
  cheatseq_t cheat_choppers = new cheatseq_t(cheat_choppers_seq, 0);
  private final char[] cheat_god_seq = {0xb2, 0x26, 0x26, 0xaa, 0x26, 0xff // iddqd
  };
  cheatseq_t cheat_god = new cheatseq_t(cheat_god_seq, 0);
  private final char[] cheat_ammo_seq = {0xb2, 0x26, 0xf2, 0x66, 0xa2, 0xff // idkfa
  };
  cheatseq_t cheat_ammo = new cheatseq_t(cheat_ammo_seq, 0);
  private final char[] cheat_ammonokey_seq = {0xb2, 0x26, 0x66, 0xa2, 0xff // idfa
  };
  ...
  private final char[] cheat_noclip_seq = {0xb2, 0x26, 0xea, 0x2a, 0xb2, // idspispopd
      0xea, 0x2a, 0xf6, 0x2a, 0x26, 0xff};
  cheatseq_t cheat_noclip = new cheatseq_t(cheat_noclip_seq, 0);
  //
  private final char[] cheat_commercial_noclip_seq =
      {0xb2, 0x26, 0xe2, 0x36, 0xb2, 0x2a, 0xff // idclip
      };
  cheatseq_t cheat_commercial_noclip =
      new cheatseq_t(cheat_commercial_noclip_seq, 0);
  private final char[][] cheat_powerup_seq =
  ...
  private final char[] cheat_clev_seq =
  ...
  // my position cheat
  private final char[] cheat_mypos_seq =
  ...
  public void refreshBackground() {
    ...
    if (st_statusbaron[0]) {
      ...
      if (DOOM.netgame) {
        DOOM.graphicSystem.DrawPatchScaled(SB, faceback, DOOM.vs, ST_FX, ST_Y,
            V_SAFESCALE | V_NOSCALESTART);
  ...
  public boolean Responder(event_t ev) {
    if (ev.isType(evtype_t.ev_keydown)) {
      if (!DOOM.netgame) {
        ...
        else if (ev.ifKeyAsciiChar(cheat_noclip::CheckCheat) ||
            ev.ifKeyAsciiChar(cheat_commercial_noclip::CheckCheat)) {
  ...
  class st_binicon_t
    ...
    public st_binicon_t(int x, int y, patch_t i, boolean[] val, int valindex, boolean[] on,
                        int onindex) {
      this.x = x;
      this.y = y;
      this.oldval = false;
      ...
      if (bi.on[onindex] && ((bi.oldval != bi.val[valindex]) || refresh)) {
        ...
        if (bi.val[valindex]) {
          final Rectangle rect =
              new Rectangle(x, ST_Y, w * DOOM.vs.getScalingX(), h * DOOM.vs.getScalingY());
  ...
  class st_multicon_t
    ...
    public void update(boolean refresh) {
      ...
      if (this.on[onindex] && ((this.oldinum != thevalue) || refresh)
        ...
        DOOM.graphicSystem.DrawPatchScaled(FG, this.p[thevalue], DOOM.vs, this.x, this.y,
            V_SCALEOFFSET | V_NOSCALESTART);
  ...
  class st_number_t
    ...
    public void drawNum(boolean refresh) {
      ...
      DOOM.graphicSystem.CopyRect(SB, rect, FG,
      ...
      {
        DOOM.graphicSystem.DrawPatchScaled(FG, p[0], DOOM.vs, x - w, this.y,
            V_NOSCALESTART | V_TRANSLUCENTPATCH);
      }
      ...
      while (((num != 0) && (numdigits-- != 0))) {
        ...
        DOOM.graphicSystem.DrawPatchScaled(FG, p[num % 10], DOOM.vs, x, this.y,
            V_NOSCALESTART | V_TRANSLUCENTPATCH);
        num /= 10;
      }
      ...
      if (neg) {
        DOOM.graphicSystem.DrawPatchScaled/*DrawPatch*/(FG, sttminus, DOOM.vs,
            x - 8 * DOOM.vs.getScalingX(), this.y, V_NOSCALESTART | V_TRANSLUCENTPATCH);
      }
