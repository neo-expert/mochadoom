...
public enum BinarySearch {
  ...
  public static <T> int findByInt(final List<? extends T> list,
                                  ...
                                  final int from, final int to, final int key) {
    final IntFunction<? extends T> getter = listGetter(list);
    return findByIndex(i -> comparator.applyAsInt(converter.applyAsInt(getter.apply(i)), key), from,
        to);
  }
  ...
  public static <T> int findByLong(final List<? extends T> list,
                                   ...
                                   final int from, final int to, final long key) {
    final IntFunction<? extends T> getter = listGetter(list);
    return findByIndex(i -> comparator.compareAsLong(converter.applyAsLong(getter.apply(i)), key),
        from, to);
  }
  ...
  public static <T> int findByLong(final T[] array,
                                   ...
                                   final int from, final int to, final long key) {
    rangeCheck(array.length, from, to);
    return findByIndex(i -> comparator.compareAsLong(converter.applyAsLong(array[i]), key), from,
        to);
  }
  ...
  public static <T> int findByDouble(final List<? extends T> list,
    ...
    final IntFunction<? extends T> getter = listGetter(list);
    return findByIndex(
        i -> comparator.compareAsDouble(converter.applyAsDouble(getter.apply(i)), key), from, to);
  }
  ...
  public static <T> int findByDouble(final T[] array,
                                     ...
                                     final int from, final int to, final double key) {
    rangeCheck(array.length, from, to);
    return findByIndex(i -> comparator.compareAsDouble(converter.applyAsDouble(array[i]), key),
        from, to);
  }
  ...
  private static <T, L extends List<? extends T>> IntFunction<? extends T> listGetter(
      final L list) {
