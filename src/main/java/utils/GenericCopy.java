...
public class GenericCopy {
  ...
  public static <T> void memset(T array, int start, int length, T value, int valueStart,
                                int valueLength) {
  ...
  public static <T> T[] malloc(final ArraySupplier<T> supplier, final IntFunction<T[]> generator,
                               final int length) {
