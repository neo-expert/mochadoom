  ...
  default void VerticalDoor(vldoor_t door) {
    switch (door.direction) {
      ...
      case -1: {
        // DOWN
        final result_e res =
            MovePlane(door.sector, door.speed, door.sector.floorheight, false, 1, door.direction);
      ...
      case 1: {
        // UP
        final result_e res =
            this.MovePlane(door.sector, door.speed, door.topheight, false, 1, door.direction);
    ...
    switch (line.special) {
      ...
      case 32:
        ...
        if (!player.cards[card_t.it_bluecard.ordinal()] &&
            !player.cards[card_t.it_blueskull.ordinal()]) {
      ...
      case 33:
        ...
        if (!player.cards[card_t.it_redcard.ordinal()] &&
            !player.cards[card_t.it_redskull.ordinal()]) {
