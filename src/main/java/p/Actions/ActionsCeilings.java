...
public interface ActionsCeilings extends ActionsMoveEvents, ActionsUseEvents {
  ...
  result_e MovePlane(sector_t sector, int speed, int bottomheight, boolean crush, int i,
                     int direction);
  ...
  default void MoveCeiling(ceiling_t ceiling) {
    ...
    switch (ceiling.direction) {
      ...
      case 1:
        // UP
        res = MovePlane(ceiling.sector, ceiling.speed, ceiling.topheight, false, 1,
            ceiling.direction);
      ...
      case -1:
        // DOWN
        res = MovePlane(ceiling.sector, ceiling.speed, ceiling.bottomheight, ceiling.crush, 1,
            ceiling.direction);
