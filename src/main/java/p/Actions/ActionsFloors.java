...
public interface ActionsFloors extends ActionsPlats {
  ...
  result_e MovePlane(sector_t sector, int speed, int floordestheight, boolean crush, int i,
                     int direction);
  ...
  default void MoveFloor(floormove_t floor) {
    final result_e res = MovePlane(floor.sector, floor.speed, floor.floordestheight, floor.crush, 0,
        floor.direction);
