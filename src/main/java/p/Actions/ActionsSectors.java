...
public interface ActionsSectors
    extends ActionsLights, ActionsFloors, ActionsDoors, ActionsCeilings, ActionsSlideDoors {

  ContextKey<RespawnQueue> KEY_RESP_QUEUE =
      ACTION_KEY_CHAIN.newKey(ActionsSectors.class, RespawnQueue::new);
   ...
   */
  @Override
  default result_e MovePlane(sector_t sector, int speed, int dest, boolean crush,
