...
public class LevelLoader extends AbstractLevelLoader {
  ...
  public void LoadVertexes(int lump) throws IOException {
    ...
    vertexes =
        DOOM.wadLoader.CacheLumpNumIntoArray(lump, numvertexes, vertex_t::new, vertex_t[]::new);
  ...
  public void LoadSideDefs(int lump) throws IOException {
    ...
    data = DOOM.wadLoader.CacheLumpNumIntoArray(lump, numsides, mapsidedef_t::new,
        mapsidedef_t[]::new);
  ...
  public void LoadBlockMap(int lump) throws IOException {
        ...
        || (count = DOOM.wadLoader.LumpLength(lump) / 2) >= 0x10000) // e6y
    {
      ...
      if (!VerifyBlockMap(count)) {
        System.err
            .print("P_LoadBlockMap: erroneous BLOCKMAP lump may cause crashes.\n");
        System.err
            .print("P_LoadBlockMap: use \"-blockmap\" command line switch for rebuilding\n");
      }
