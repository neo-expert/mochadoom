...
public abstract class UnifiedGameMap implements ThinkerList {
  ...
  public class Specials {
    ...
    public final void resizeLinesSpecialList() {
      linespeciallist =
          C2JUtils.resize(linespeciallist[0], linespeciallist, linespeciallist.length * 2);
    }
        ...
        if (eval(buttonlist1.btimer)) {
          ...
          if (!eval(buttonlist1.btimer)) {
            switch (buttonlist1.where) {
              case top:
                DOOM.levelLoader.sides[buttonlist1.line.sidenum[0]].toptexture =
                    (short) buttonlist1.btexture;
                break;
              case middle:
                DOOM.levelLoader.sides[buttonlist1.line.sidenum[0]].midtexture =
                    (short) buttonlist1.btexture;
                break;
              case bottom:
                DOOM.levelLoader.sides[buttonlist1.line.sidenum[0]].bottomtexture =
                    (short) buttonlist1.btexture;
                break;
            }
