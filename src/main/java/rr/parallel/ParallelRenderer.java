...
//            visplanebarrier.await();
  ...
  protected void InitParallelStuff() {
    ...
    if (!(RWIs == null)) {
      ...
      detailaware.addAll(Arrays.asList(RWIExec).subList(0, NUMWALLTHREADS));
    }
  ...
  public static final class Indexed extends ParallelRenderer<byte[], byte[]> {
    ...
    public RenderWallExecutor<byte[], byte[]>[] InitRWIExecutors(
      ...
      for (int i = 0; i < num; i++) {
        tmp[i] = new RenderWallExecutor.Indexed(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
  ...
  public static final class HiColor extends ParallelRenderer<byte[], short[]> {
    ...
    public RenderWallExecutor<byte[], short[]>[] InitRWIExecutors(
      ...
      for (int i = 0; i < num; i++) {
        tmp[i] = new RenderWallExecutor.HiColor(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
            columnofs, ylookup, screen, RWI, drawsegsbarrier);
      }
  ...
  public static final class TrueColor extends ParallelRenderer<byte[], int[]> {
    ...
    public RenderWallExecutor<byte[], int[]>[] InitRWIExecutors(
      ...
      for (int i = 0; i < num; i++) {
        tmp[i] =
            new RenderWallExecutor.TrueColor(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
                columnofs, ylookup, screen, RWI, drawsegsbarrier);
      }
