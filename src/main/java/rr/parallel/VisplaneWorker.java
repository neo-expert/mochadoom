...
public abstract class VisplaneWorker<T, V> extends PlaneDrawer<T, V>
  ...
  public VisplaneWorker(DoomMain<T, V> DOOM, int id, int SCREENWIDTH, int SCREENHEIGHT,
                        SceneRenderer<T, V> R, CyclicBarrier visplanebarrier, int NUMFLOORTHREADS) {
    super(DOOM, R);
  ...
  public static final class HiColor extends VisplaneWorker<byte[], short[]> {
    ...
    public HiColor(DoomMain<byte[], short[]> DOOM, int id, int SCREENWIDTH, int SCREENHEIGHT,
                   SceneRenderer<byte[], short[]> R,
      ...
      vpw_spanfunc = vpw_spanfunchi =
          new R_DrawSpanUnrolled.HiColor(SCREENWIDTH, SCREENHEIGHT, ylookup, columnofs, vpw_dsvars,
              screen, I);
      vpw_spanfunclow =
          new R_DrawSpanLow.HiColor(SCREENWIDTH, SCREENHEIGHT, ylookup, columnofs, vpw_dsvars,
              screen, I);
      vpw_skyfunc = vpw_skyfunchi =
          new R_DrawColumnBoomOpt.HiColor(SCREENWIDTH, SCREENHEIGHT, ylookup, columnofs, vpw_dcvars,
              screen, I);
      vpw_skyfunclow =
          new R_DrawColumnBoomOptLow.HiColor(SCREENWIDTH, SCREENHEIGHT, ylookup, columnofs,
              vpw_dcvars, screen, I);
