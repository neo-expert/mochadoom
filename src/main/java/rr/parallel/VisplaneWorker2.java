...
public abstract class VisplaneWorker2<T, V> extends PlaneDrawer<T, V>
  ...
  public VisplaneWorker2(DoomMain<T, V> DOOM, SceneRenderer<T, V> R, int id,
  ...
  public static class HiColor extends VisplaneWorker2<byte[], short[]> {
    ...
    public HiColor(DoomMain<byte[], short[]> DOOM, SceneRenderer<byte[], short[]> R, int id,
      ...
      vpw_spanfunc = vpw_spanfunchi =
          new R_DrawSpanUnrolled.HiColor(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
              ylookup, columnofs, vpw_dsvars, screen, I);
      vpw_spanfunclow =
          new R_DrawSpanLow.HiColor(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(), ylookup,
              columnofs, vpw_dsvars, screen, I);
      vpw_skyfunc = vpw_skyfunchi =
          new R_DrawColumnBoomOpt.HiColor(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
              ylookup, columnofs, vpw_dcvars, screen, I);
      vpw_skyfunclow =
  ...
  public static class Indexed extends VisplaneWorker2<byte[], byte[]> {
    ...
    public Indexed(DoomMain<byte[], byte[]> DOOM, SceneRenderer<byte[], byte[]> R, int id,
      ...
      super(DOOM, R, id, visplanebarrier, NUMFLOORTHREADS);
      vpw_spanfunc = vpw_spanfunchi =
          new R_DrawSpanUnrolled.Indexed(DOOM.vs.getScreenWidth(), DOOM.vs.getScreenHeight(),
              ylookup, columnofs, vpw_dsvars, screen, I);
      vpw_spanfunclow =
